...
export const allNews = [
  ...
  },
  {
    id: 2,
    title: '14:59',
    time: 'До Європи за захистом. Що означає позов Ахметова до Європейського суду з прав людини',
    category: 'news',
    accent: null,
  },
  {
    id: 3,
    title: '14:59',
    time: 'Прем`єрка Швеції відвідала потрощені росіянами Бучу й Бородянку: реакція на побачене',
    category: 'articles',
    accent: null,
  },
  {
  ...
  },
  {
    id: 5,
    title: '14:59',
    time: 'Стало відомо, коли ЄС може узгодити сьомий пакет санкцій проти рф',
    category: 'articles',
    accent: null,
  },
  {
